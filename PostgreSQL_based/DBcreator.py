...
def main():
    ...
    for table,query in creation_dict.items():
        ...
        conn = psycopg2.connect(database="pysamdb", user='postgres', password='warszawa4361', host='127.0.0.1', port= '5432')
    ...
    print('Congratulations! Database PysamDB.db schema is now created. \n')
